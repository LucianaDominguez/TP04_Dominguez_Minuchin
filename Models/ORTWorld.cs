public class ORTWorld
{
    ...
    public static List<string> ListaAereos  {get;private set;} = new List<string> (){"Iberia","Air France","British Airways","Lufthansa","American Airlines","RyanAir","Alitalia","Turkish Airlines","Emirates","Qatar Airways"};
